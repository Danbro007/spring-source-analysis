...
public class Jaxb2RootElementHttpMessageConverter extends AbstractJaxb2HttpMessageConverter<Object> {
	...
	/**
	 * Indicate whether external XML com.danbro.spring.entities are processed when converting to a Source.
	...
	protected Source processSource(Source source) {
		if (source instanceof StreamSource) {
			...
			try {
				...
				logger.warn("Processing of external com.danbro.spring.entities could not be disabled", ex);
				return source;
			}
		}
		else {
