...
public class PathMatchConfigurer {
	...
	/**
	 * Configure a path prefix to apply to matching com.danbro.springmvc.controller methods.
	 ...
	 * @param predicate a predicate for matching com.danbro.springmvc.controller types
	 * @since 5.1
	 */
