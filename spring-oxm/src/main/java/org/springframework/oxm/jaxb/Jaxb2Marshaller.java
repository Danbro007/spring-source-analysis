...
public class Jaxb2Marshaller implements MimeMarshaller, MimeUnmarshaller, GenericMarshaller, GenericUnmarshaller,
	...
	/**
	 * Indicate whether external XML com.danbro.spring.entities are processed when unmarshalling.
	 * <p>Default is {@code false}, meaning that external com.danbro.spring.entities are not resolved.
	 * Note that processing of external com.danbro.spring.entities will only be enabled/disabled when the
	...
	/**
	 * Return whether XML external com.danbro.spring.entities are allowed.
	 */
	...
	private Source processSource(Source source) {
		...
		try {
			...
			logger.info("Processing of external com.danbro.spring.entities could not be disabled", ex);
			return source;
		}
	}
