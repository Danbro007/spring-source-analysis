...
[[mvc-cors-com.danbro.springmvc.controller]]
== `@CrossOrigin`
[.small]#<<web-reactive.adoc#webflux-cors-com.danbro.springmvc.controller, Same as in Spring WebFlux>>#

The {api-spring-framework}/web/bind/annotation/CrossOrigin.html[`@CrossOrigin`]
annotation enables cross-origin requests on annotated com.danbro.springmvc.controller methods,
...
* All origins.
* All headers.
* All HTTP methods to which the com.danbro.springmvc.controller method is mapped.
...
In addition to fine-grained, com.danbro.springmvc.controller method level configuration, you probably want to
