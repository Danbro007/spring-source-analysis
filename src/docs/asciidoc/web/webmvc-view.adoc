...
shown in the preceding example. Given the preceding configuration, if your com.danbro.springmvc.controller
...
com.danbro.springmvc.controller, you can use code similar to the next example to bind to field values and
...
object (it is 'command', unless you changed it in your com.danbro.springmvc.controller configuration) followed
...
* `options`: A `Map` of all the available values that can be selected from in the input
  ...
  com.danbro.springmvc.controller. You can use any `Map` implementation, depending on required behavior.
...
The com.danbro.springmvc.controller would look no different for the Java and XML configurations, as the following example shows:
...
com.danbro.springmvc.controller deals with. As we show in the following examples, the form tags make
...
form com.danbro.springmvc.controller, which returns `form.jsp`. The following example shows what `form.jsp` could
look like:
...
the `PageContext` by the page com.danbro.springmvc.controller. Keep reading to see more complex examples of
...
created in your com.danbro.springmvc.controller or those that were created by any validators associated with
your com.danbro.springmvc.controller.
...
A com.danbro.springmvc.controller can return such a view either from an external view definition
...
name of our XSLT view. See <<mvc-com.danbro.springmvc.controller>> for details of Spring Web MVC's
`Controller` interface. The XSLT com.danbro.springmvc.controller turns the list of words into a simple XML
...
The com.danbro.springmvc.controller logic is encapsulated in a `@Controller` class, with the
