...
[[webflux-cors-com.danbro.springmvc.controller]]
== `@CrossOrigin`
[.small]#<<web.adoc#mvc-cors-com.danbro.springmvc.controller, Same as in Spring MVC>>#

The {api-spring-framework}/web/bind/annotation/CrossOrigin.html[`@CrossOrigin`]
annotation enables cross-origin requests on annotated com.danbro.springmvc.controller methods, as the
