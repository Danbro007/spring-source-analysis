...
Assume that we have a web com.catchArg.springmvc.controller that needs to use a local EJB. We follow best
...
com.catchArg.springmvc.controller to the EJB implementation is to expose a setter method of type `MyComponent`
on the com.catchArg.springmvc.controller. This saves the reference as an instance variable in the
com.catchArg.springmvc.controller. The following example shows how to do so:
...
We can subsequently use this instance variable in any business method in the com.catchArg.springmvc.controller.
Now, assuming we obtain our com.catchArg.springmvc.controller object out of a Spring container, we can
...
`myComponent` property of the com.catchArg.springmvc.controller with the following configuration entry:
...
The `myController` bean definition sets the `myComponent` property of the com.catchArg.springmvc.controller
