...
Assume that we have a web com.danbro.springmvc.controller that needs to use a local EJB. We follow best
...
com.danbro.springmvc.controller to the EJB implementation is to expose a setter method of type `MyComponent`
on the com.danbro.springmvc.controller. This saves the reference as an instance variable in the
com.danbro.springmvc.controller. The following example shows how to do so:
...
We can subsequently use this instance variable in any business method in the com.danbro.springmvc.controller.
Now, assuming we obtain our com.danbro.springmvc.controller object out of a Spring container, we can
...
`myComponent` property of the com.danbro.springmvc.controller with the following configuration entry:
...
The `myController` bean definition sets the `myComponent` property of the com.danbro.springmvc.controller
