...
[[webtestclient-com.catchArg.springmvc.controller-config]]
=== Bind to Controller
...
and registers the given com.catchArg.springmvc.controller. The resulting WebFlux application is tested
