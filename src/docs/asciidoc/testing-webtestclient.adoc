...
[[webtestclient-com.danbro.springmvc.controller-config]]
=== Bind to Controller
...
and registers the given com.danbro.springmvc.controller. The resulting WebFlux application is tested
