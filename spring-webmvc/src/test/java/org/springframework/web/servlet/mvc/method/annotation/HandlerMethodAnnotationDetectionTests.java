...
class HandlerMethodAnnotationDetectionTests {
	...
	private void setUp(Class<?> controllerType, boolean useAutoProxy) {
		...
		context.registerBeanDefinition("com.danbro.springmvc.controller", new RootBeanDefinition(controllerType));
	...
	@ParameterizedTest(name = "[{index}] com.danbro.springmvc.controller [{0}], auto-proxy [{1}]")
