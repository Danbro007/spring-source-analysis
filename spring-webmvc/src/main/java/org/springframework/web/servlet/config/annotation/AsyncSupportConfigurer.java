...
public class AsyncSupportConfigurer {
	 ...
	 * <ol>
	 * <li>Handle {@link Callable} com.danbro.springmvc.controller method return values.
	 * <li>Perform blocking writes when streaming to the response
	 * through a reactive (e.g. Reactor, RxJava) com.danbro.springmvc.controller method return value.
	 * </ol>
	 ...
	 * execution that starts when a com.danbro.springmvc.controller returns a
	...
	/**
	 * Configure lifecycle interceptors with callbacks around concurrent request
	 * execution that starts when a com.danbro.springmvc.controller returns a {@link DeferredResult}.
	 * @param interceptors the interceptors to register
	 */
