...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	 ...
	 * @see #afterPropertiesSet()
	 */
	//调用的其实是 AbstractApplicationContext 的构造器
	...
	public ClassPathXmlApplicationContext(
		...
		//如果参数含有 Context 则会调用 AbstractApplicationContext 的 含参构造器 AbstractApplicationContext(@Nullable ApplicationContext parent)
		//如果没有则会配置上资源解析器来解析applicationContext.xml配置文件
		super(parent);
		//加载配置文件applicationContext.xml
		setConfigLocations(configLocations);
		//是否刷新 默认为true 自动刷新context
		if (refresh) {
			//核心方法
			refresh();
		}
